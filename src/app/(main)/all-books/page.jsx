...
const AllBooksPage = () => {
  ...
  const categories = [
    ...
    const filteredBook = allBooks.filter((book) =>{
      const categoryMatch = selectedCategory === "All"?true: book.category === selectedCategory
     const searchMatch = book.title.toLowerCase().includes(search.toLocaleLowerCase())
